        ...
        >
          <div className="fixed inset-0 flex justify-center items-center z-[999]">
            <Dialog.Panel className={"bg-gray-400 max-w-5xl w-full relative"}>
              ...
              <div className="absolute bottom-5 inset-x-0 text-center z-10 text-lg">
              ...
              <div className="bg-white/50 h-15 w-15 fixed sm:absolute z-[999] right-4 top-2 rounded-full">
                <BsX
